...
func (g *ClientFactoryGenerator) GenerateClientFactory() error {
	...
	if err != nil {
		return fmt.Errorf("generated code is not valid Go (template bug): %w\n--- source ---\n%s", err, code)
	}

	return WriteFileAtomic(g.outputPath, formatted, 0644)
}
...
const clientFactoryTemplate = `// Code generated by client_factory_generator.go. DO NOT EDIT.
